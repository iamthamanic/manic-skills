...
title_de: How to load your websites at lightning speed?
tags: [general]
...
## Zusammenfassung (DE)
- (Text-Extrakt — Diagramm siehe PDF Seite 255. Vision-Ingest kann DE-Summary ergänzen.)

## Diagram (what it shows)
- Refer to `assets/linkedin-posts-2024-blue.pdf` page 255 for the infographic.
...
| EN | DE |
|----|-----|
| See summary bullets | Siehe Summary — bei Unsicherheit PDF Seite 255 |
