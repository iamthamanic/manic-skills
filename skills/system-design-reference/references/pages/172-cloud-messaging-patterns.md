---
page: 172
title: Cloud Messaging Patterns
title_de: Cloud Messaging Patterns
...
- Let’s review the popular Kafka use cases. - Log processing and analysis - Data streaming in recommendations - System monitoring and alerting - CDC (Change data capture)

## Zusammenfassung (DE)
- (Text-Extrakt — Diagramm siehe PDF Seite 172. Vision-Ingest kann DE-Summary ergänzen.)

## Diagram (what it shows)
- Refer to `assets/linkedin-posts-2024-blue.pdf` page 172 for the infographic.
...
| EN | DE |
|----|-----|
| See summary bullets | Siehe Summary — bei Unsicherheit PDF Seite 172 |
