---
page: 338
title: A Cheatsheet for UML Class Diagrams
title_de: A Cheatsheet for UML Class Diagrams
tags: [general]
...
## Zusammenfassung (DE)
- (Text-Extrakt — Diagramm siehe PDF Seite 338. Vision-Ingest kann DE-Summary ergänzen.)

## Diagram (what it shows)
- Refer to `assets/linkedin-posts-2024-blue.pdf` page 338 for the infographic.
...
| EN | DE |
|----|-----|
| See summary bullets | Siehe Summary — bei Unsicherheit PDF Seite 338 |
