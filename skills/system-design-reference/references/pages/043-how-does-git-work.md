...
## Zusammenfassung (DE)
- (Text-Extrakt — Diagramm siehe PDF Seite 43. Vision-Ingest kann DE-Summary ergänzen.)

## Diagram (what it shows)
- Refer to `assets/linkedin-posts-2024-blue.pdf` page 43 for the infographic.
...
| EN | DE |
|----|-----|
| See summary bullets | Siehe Summary — bei Unsicherheit PDF Seite 43 |
